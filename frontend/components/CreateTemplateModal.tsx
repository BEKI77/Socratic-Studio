...
import type { Template, CreateTemplateModalProps } from "../types/types"

export default function CreateTemplateModal({ isOpen, onClose, onCreateTemplate, editingTemplate = null }: CreateTemplateModalProps) {
  const [templateName, setTemplateName] = useState<string>(editingTemplate?.name || "")
  const [templateContent, setTemplateContent] = useState<string>(editingTemplate?.content || "")
